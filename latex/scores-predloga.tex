...
\begin{figure}[H]
    ...
    \caption{Razmerje SoC (Local Leaders / LaCAM) po tipu zemljevida. Vrednost
    pod 1 pomeni, da Local Leaders doseže nižji SoC kot LaCAM.}
    \label{fig:overhead}
\end{figure}

Slika~\ref{fig:overhead} nazorno prikaže, da Local Leaders pri vseh tipih
zemljevidov in pri vseh preizkušenih gostotah agentov doseže nižji SoC kot
LaCAM (razmerje $< 1{,}0$). Na naključnih zemljevidih razmerje pada z
naraščajočim številom agentov: od 0{,}994 (8 agentov) do 0{,}913 (64 agentov).
Na skladiščnih zemljevidih je razmerje med 0{,}888 (8 agentov) in 0{,}913 (32
agentov), kar nakazuje, da lokalna koordinacija v regularnih skladiščnih
vzorcih učinkoviteje izkorišča strukturo prostora. Na labirintnih zemljevidih
razmerje niha (0{,}994 pri 4, $\approx 0{,}924$ pri 8, $\approx 0{,}960$ pri
16 agentih), a ostaja pod $1{,}0$.
...
\begin{figure}[H]
    ...
    \caption{Lifelong pretočnost MATS-LP in Local Leaders po tipu zemljevida
    (naključni, labirint, skladišče). Na skladiščnih zemljevidih Local Leaders
    dosega do 7-kratno višjo pretočnost kot MATS-LP.}
    \label{fig:maptype}
\end{figure}

Slika~\ref{fig:maptype} primerja pretočnost na vseh treh tipih zemljevidov.
Na naključnih in labirintnih je MATS-LP pred Local Leaders, pri čemer razlika
narašča z gostoto agentov (MATS-LP: 0{,}906, LL: 0{,}237 pri 32 agentih v
labirintu). Toda na \emph{skladiščnih} zemljevidih se vlogi zamenjata:
Local Leaders doseže pretočnost 1{,}14 (32 agentov) oziroma 1{,}96 (96
agentov), medtem ko MATS-LP doseže le 0{,}11 oziroma 0{,}28. To je
$\approx 10$-kratna prednost Local Leaders. Vzrok je v tem, da MATS-LP v
širokih koridorjih skladišča MCTS iskanje postane izjemno računsko zahtevno
(do 1240\,s na epizodo), medtem ko greedy A* v takih prostorih deluje brez
zastojev in je 400-krat hitrejši.

\subsection{Povzetek rezultatov}

\begin{table}[H]
\centering
\caption{Povzetek primerjave po metrikah in tipih evaluacije. ++ zelo dobro,
+ dobro, $\sim$ primerljivo, - slabo, -- zelo slabo.}
\label{tab:summary}
\small
\begin{tabular}{lcccc}
\toprule
\textbf{Metrika} & \textbf{LaCAM} & \textbf{LL} & \textbf{MATS-LP} & \textbf{Follower} \\
\midrule
SoC (one-shot)            & $\sim$  & $+$  & --   & -- \\
Makespan (one-shot)       & $+$     & $+$  & --   & -- \\
Čas načrtov. (MovingAI)   & $++$    & $-$  & --   & -- \\
Stopnja uspeha (random)   & $++$    & $++$ & --   & -- \\
Stopnja uspeha (maze)     & $++$    & $-$  & --   & -- \\
...
Preglednica~\ref{tab:summary} povzema primerjavo. Local Leaders se izkaže
kot učinkovit hibridni pristop: na one-shot scenarijih dosega primerljivo ali
boljšo kakovost rešitev kot LaCAM, na lifelong scenarijih se enakovredno
kosa z MATS-LP na odprtih okoljih, na skladiščnih okoljih pa ga bistveno
prekaša. Primarne slabosti so visoka gostota ovir (30\,\% ovir) ter ozki
hodniki labirintov, kjer mehanizem naključnega pobega ne zadostuje.
