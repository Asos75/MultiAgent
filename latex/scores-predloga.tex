...
pristope k reševanju MAPF problema. Primerjali bomo centralizirane metode, kot sta LaCAM~\cite{okumura2023lacam} 
in PBS~\cite{li2019pbs}, z decentraliziranimi pristopi, kot sta Follower~\cite{andreychuk2024follower} 
in MATS-LP~\cite{skrynnik2023mats_arxiv}.
...
\begin{itemize}
    \item \textbf{Vozliščni konflikt:} Do vozliščnega konflikta (ang. vertexconflict) pride, če nameravata $ \pi_i $ in $ \pi_j $ zasedeti isto 
...
Rešitev MAPF za instance, omenjene zgoraj, je množica brezkonfliktnih poti
 $\{\pi_1,\ldots,\pi_k\}$ takih, da obstaja časovni korak $T \in \mathbb{N}_{\ge 0}$, kjer agent doseže cilj.
