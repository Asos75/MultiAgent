...
\begin{itemize}
    \item \textit{LaCAM: Search-Based Algorithm for Quick Multi-Agent Pathfinding}~\cite{okumura2023lacam},
    \item \textit{Priority-Based Search for Multi-Agent Path Finding}~\cite{li2019pbs},
    \item \textit{Follower: Learning to Solve Decentralized Lifelong Multi-Agent Pathfinding}~\cite{andreychuk2024follower},
    \item \textit{MATS-LP: Learning Decentralized Multi-Agent Pathfinding with Transformer-Based Policies}~\cite{skrynnik2024mcts}.
\end{itemize}
...
\subsection{Centralizirani pristopi}
    ...
    ob majhni, dokazljivo omejeni degradaciji kakovosti rešitve. \textbf{Doprinos k našemu eksperimentu:} 
    EECBS uporabimo kot referenčno izhodišče za razumevanje kompromisa »hitrost vs. kvaliteta« pri centraliziranih 
    metodah; njegove ideje utemeljijo, zakaj v evalvaciji poleg kakovosti (SoC/makespan) spremljamo tudi čas 
    ...
    \textbf{Doprinos k našemu eksperimentu:} CBSH2 obravnavamo kot dodatno referenco znotraj centraliziranih metod, 
    ki pokaže, da so izboljšave pogosto posledica boljšega upravljanja konfliktov; to nam pomaga pri interpretaciji 
    rezultatov LaCAM/PBS (kjer tudi ciljamo na učinkovitejšo obravnavo konfliktov), če opazimo razlike predvsem v 
    času in ne v SoC.
...
\subsection{Decentralizirani pristopi}
    ...
    vendar je kakovost poti odvisna od lokalnih informacij in stabilnosti naučene politike. \textbf{Doprinos k 
    našemu eksperimentu:} Follower je eden naših glavnih decentraliziranih primerjalnih algoritmov; z njim 
    ovrednotimo, kako se učeni, lokalni pristopi primerjajo s centraliziranima LaCAM/PBS in z našim hibridnim 
    ...
    eksplicitne komunikacije ali centralnega koordinatorja), kar vodi do dobre skalabilnosti. \textbf{Doprinos k 
    našemu eksperimentu:} delo utemeljuje našo izbiro decentraliziranih primerjalnih metod na POGEMA (delna opazljivost) 
    in je neposredno relevantno za komponento MATS-LP v naši primerjavi, kjer želimo videti, ali »lookahead« (MCTS) 
    izboljša pretočnost in robustnost glede na bolj reaktivne politike.
    ...
    optimalnost in lahko povzroča neusklajenosti v gostih scenarijih. \textbf{Doprinos k našemu eksperimentu:} PRIMAL2 
    ...
    \textbf{Doprinos k našemu eksperimentu:} SCRIMP služi kot motivacija za naš »hibridni« pogled (lokalni vodje): kaže, da lahko 
...
\subsection{Primerjalne platforme}
    ...
    različnih pristopov. \textbf{Doprinos k našemu eksperimentu:} POGEMA je naše glavno evalvacijsko ogrodje, zato se metodologija, 
    metrike in primerjava rezultatov neposredno opirajo na to delo.
