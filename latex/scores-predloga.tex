...
\begin{abstract}
V tem delu obravnavamo problem večagentnega iskanja poti MAPF, kjer primerjamo centralizirane in
decentralizirane algoritme, ter predlagamo svoj hibridni pristop z lokalnimi vodijami (\textit{local leaders}).
Algoritem agente dinamično razporeja v lokalne skupine, znotraj katerih vodja koordinira gibanje s
prioritetno razrešitvijo konfliktov in algoritmom A*. Predlagani pristop primerjamo s centraliziranimi
algoritmi LaCAM in PBS ter decentraliziranima algoritmoma Follower in MATS-LP na standardiziranih zbirkah
