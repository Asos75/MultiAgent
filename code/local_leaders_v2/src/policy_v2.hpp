...
public:
    explicit LocalLeadersPolicy(int num_agents, unsigned seed = 0, PolicyConfig config = {});
...
private:
    ...
    IntVec             leader_of_;
    PosVec             desired_;
    PosVec             agent_wants_;   // after intra-group resolution
    PosVec             final_pos_;
    ...
    Pos best_alternative(Pos pos, Pos target, const Committed& committed,
